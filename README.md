...
* **Master Chester County Precinct Database:** Includes a complete **`public/precincts.json`** file of all 230 Chester County precincts mapped precisely to their numbers and township/borough names.
